...
-->
        ...
        <div class="postarea">
        	<?php query_posts("showposts=25&post_type=post&orderby=date"); ?>
		...
		<a href="<?php the_permalink() ?>">
            ...
            <?php endif; ?>
                <p>Jos etsit tätä vanhempia artikkeleita, siirry <a href='http://www.jylkkari.fi/arkistot/'>arkistoon</a></p>
        </div>